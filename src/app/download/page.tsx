...
export const metadata = buildMetadata({
  ...
  description:
    "Get Homework Buddy on Google Play and the App Store. Kids create their own printable homework for Nursery to Class 3 — Reading, Maths, Hindi Fun, and more.",
  path: "/download",
});
    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="text-center">
        ...
        <p className="mt-4 text-lg font-semibold text-[#7D7788]">
          Kids create their own printable homework — Nursery to Class 3. Free on Google Play and the App
          Store.
        </p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <PlayStoreBadge placement="download_hero" className="inline-block" priority />
          <AppStoreBadge placement="download_hero" className="inline-block" priority />
        </div>
